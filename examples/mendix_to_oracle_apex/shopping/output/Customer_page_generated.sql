...
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#PHONE#\'
...
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#EMAIL#\'
...
,p_sort_column_1=>'PHONE'
,p_sort_direction_1=>'ASC'
);
wwv_flow_imp_page.create_page_button(
p_button_sequence=>10,
p_button_plug_id=>7610,
p_button_name=>'ADD CUSTOMER'
...
wwv_flow_imp_page.create_page_da_event(
 ...
 p_id=>7328,  -- give it a unique ID
 p_name=>'Edit Report - Dialog Closed',
 p_event_sequence=>10,
 p_triggering_element_type=>'REGION',
 p_triggering_region_id=>7610,
 p_bind_type=>'bind',
...
wwv_flow_imp_page.create_page_da_action(
 ...
 p_id=>7328,  -- unique ID for the action
 p_event_id=>7328,  -- link to parent DA event
 p_event_result=>'TRUE',
 p_action_sequence=>10,
 p_execute_on_page_init=>'N',
 p_action=>'NATIVE_REFRESH',
 p_affected_elements_type=>'REGION',
 p_affected_region_id=>7610
);
end;
/
