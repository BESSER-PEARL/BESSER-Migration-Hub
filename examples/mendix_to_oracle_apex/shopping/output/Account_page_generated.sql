...
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#BILLING_ADDRESS#\'
,p_column_linktext=>'#BILLING_ADDRESS#'
...
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#OPEN_DATE#\'
,p_column_linktext=>'#OPEN_DATE#'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'BILLING_ADDRESS:OPEN_DATE'
,p_sort_column_1=>'BILLING_ADDRESS'
,p_sort_direction_1=>'ASC'
);
wwv_flow_imp_page.create_page_button(
p_button_sequence=>10,
p_button_plug_id=>4986,
p_button_name=>'ADD ACCOUNT'
...
wwv_flow_imp_page.create_page_da_event(
 ...
 p_id=>8714,  -- give it a unique ID
 p_name=>'Edit Report - Dialog Closed',
 p_event_sequence=>10,
 p_triggering_element_type=>'REGION',
 p_triggering_region_id=>4986,
 p_bind_type=>'bind',
...
wwv_flow_imp_page.create_page_da_action(
 ...
 p_id=>8714,  -- unique ID for the action
 p_event_id=>8714,  -- link to parent DA event
 p_event_result=>'TRUE',
 p_action_sequence=>10,
 p_execute_on_page_init=>'N',
 p_action=>'NATIVE_REFRESH',
 p_affected_elements_type=>'REGION',
 p_affected_region_id=>4986
);
end;
/
