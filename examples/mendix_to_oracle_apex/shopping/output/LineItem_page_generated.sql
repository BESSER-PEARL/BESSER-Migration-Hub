...
p_id => 1575,
p_plug_name=>'LineItems',
p_region_template_options=>'#DEFAULT#',
p_plug_display_sequence=>10,
p_query_type=>'TABLE',
p_query_table=>'LINEITEM',
p_include_rowid_column=>false,
p_plug_source_type=>'NATIVE_IR',
p_prn_page_header=>'LineItem'
);
...
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#PRICE#\'
...
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#QUANTITY#\'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PRICE:QUANTITY'
,p_sort_column_1=>'PRICE'
,p_sort_direction_1=>'ASC'
);
wwv_flow_imp_page.create_page_button(
p_button_sequence=>10,
p_button_plug_id=>1575,
p_button_name=>'ADD LINE ITEM'
...
wwv_flow_imp_page.create_page_da_event(
 ...
 p_id=>4975,  -- give it a unique ID
 p_name=>'Edit Report - Dialog Closed',
 p_event_sequence=>10,
 p_triggering_element_type=>'REGION',
 p_triggering_region_id=>1575,
 p_bind_type=>'bind',
...
wwv_flow_imp_page.create_page_da_action(
 ...
 p_id=>4975,  -- unique ID for the action
 p_event_id=>4975,  -- link to parent DA event
 p_event_result=>'TRUE',
 p_action_sequence=>10,
 p_execute_on_page_init=>'N',
 p_action=>'NATIVE_REFRESH',
 p_affected_elements_type=>'REGION',
 p_affected_region_id=>1575
);
end;
/
