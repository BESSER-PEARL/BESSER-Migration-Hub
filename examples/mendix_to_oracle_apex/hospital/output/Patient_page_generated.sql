...
wwv_flow_imp_page.create_worksheet_column(
p_db_column_name=>'SICKNESS'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Sickness'
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#SICKNESS#\'
,p_column_linktext=>'#SICKNESS#'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
...
,p_column_link=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:6,RR:IR_ID:\#GENDER#\'
,p_column_linktext=>'#GENDER#'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
,p_use_as_row_header=>'N'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'GIVENNAME:SICKNESS:FAMILYNAME:GENDER'
,p_sort_column_1=>'GIVENNAME'
,p_sort_direction_1=>'ASC'
);
wwv_flow_imp_page.create_page_button(
p_button_sequence=>10,
p_button_plug_id=>1721,
p_button_name=>'ADD PATIENT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Add Patient'
...
wwv_flow_imp_page.create_page_da_event(
 ...
 p_id=>3407,  -- give it a unique ID
 p_name=>'Edit Report - Dialog Closed',
 p_event_sequence=>10,
 p_triggering_element_type=>'REGION',
 p_triggering_region_id=>1721,
 p_bind_type=>'bind',
...
wwv_flow_imp_page.create_page_da_action(
 ...
 p_id=>3407,  -- unique ID for the action
 p_event_id=>3407,  -- link to parent DA event
 p_event_result=>'TRUE',
 p_action_sequence=>10,
 p_execute_on_page_init=>'N',
 p_action=>'NATIVE_REFRESH',
 p_affected_elements_type=>'REGION',
 p_affected_region_id=>1721
);
end;
/
