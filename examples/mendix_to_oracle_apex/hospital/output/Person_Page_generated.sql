...
p_button_plug_id=>1304,
p_button_name=>'ADD PERSON'
...
wwv_flow_imp_page.create_page_da_event(
 ...
 p_id=>6612,  -- give it a unique ID
 p_name=>'Edit Report - Dialog Closed',
 p_event_sequence=>10,
 p_triggering_element_type=>'REGION',
 p_triggering_region_id=>1304,
 p_bind_type=>'bind',
...
wwv_flow_imp_page.create_page_da_action(
 ...
 p_id=>6612,  -- unique ID for the action
 p_event_id=>6612,  -- link to parent DA event
 p_event_result=>'TRUE',
 p_action_sequence=>10,
 p_execute_on_page_init=>'N',
 p_action=>'NATIVE_REFRESH',
 p_affected_elements_type=>'REGION',
 p_affected_region_id=>1304
);
end;
/
